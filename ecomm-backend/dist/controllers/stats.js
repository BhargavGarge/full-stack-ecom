...
import { calculatePercentage, getChartData, getInventory, } from "../utils/db.js";
...
export const getPieCharts = TryCatch(async (req, res, next) => {
    ...
    if (myCache.has("admin-pie-chats"))
        ...
        const [processingOrder, ShippedOrder, deliverdOrder, categories, productsCount, productsOutOfStock, allOrders, AllUsers, AdminUsers, customerUsers,] = await Promise.all([
